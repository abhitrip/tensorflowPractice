...
n_input = 784 # input feature dimension of mnist data
n_classes = 10 # total number of categories
...
with tf.Session() as sess:
    ...
    for epoch_i in range(epochs):
        ...
        for batch_features, batch_labels in train_batches:
            ...
            sess.run(optimiser, feed_dict=train_feed_dict)
